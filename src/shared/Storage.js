...
export const STORE_AIRPORT = (value) => {
    AsyncStorage.setItem('airports', JSON.stringify(value));
};

export const GET_STORED_AIRPORT = async () => {
    const value = await AsyncStorage.getItem('airports');
